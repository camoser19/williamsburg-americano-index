        ...
        <header className="flex items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-[#bfa382]">
              Review community-submitted iced Americano prices before they
              enter the index.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <section className="mt-12 grid gap-6">
            {submissions.map((submission) => (
              <article
                key={submission.id}
                className="rounded-[18px] border border-[#4b3524] bg-[#14100c]/95 p-6 shadow-[0_16px_40px_rgba(0,0,0,0.26)] md:p-8"
              >
                <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                  ...
                  <div className="md:text-right">
                    ...
                    >
                      ${Number(submission.price).toFixed(2)}
                    </p>

                    <p className="mt-2 text-sm italic text-[#9d7655]">
                      {formatDate(submission.observed_date)}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-7 grid gap-4 border-y border-[#37291f] py-5 text-sm sm:grid-cols-2">
                  <div>
                    ...
                    <p className="mt-1 capitalize text-[#c3a381]">
                      {submission.tax_status === "excluded"
                        ? "Not included"
                        : submission.tax_status === "included"
                        ? "Included"
                        : "Unknown"}
                    </p>
                  </div>
